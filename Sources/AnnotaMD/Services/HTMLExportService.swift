...
enum HTMLExportService {
    ...
    private static let logger = Logger(subsystem: "com.xielintao.annotamd", category: "HTMLExportService")
    ...
    static func buildSelfContainedHTML(
        ...
        let safeTitle = title.isEmpty ? "AnnotaMD" : escapeHTML(title)
        ...
        <head>
            ...
            <meta name="generator" content="AnnotaMD">
        \(styleBlock)</head>
        <body>
