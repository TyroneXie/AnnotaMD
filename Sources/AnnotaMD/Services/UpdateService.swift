...
struct GitHubRelease: Sendable {
    ...
    let name: String         // e.g. "AnnotaMD 2.0.5"
...
final class UpdateService: Sendable {
    ...
    /// GitHub 仓库所有者
    private static let owner = "TyroneXie"

    /// GitHub 仓库名称
    private static let repo = "Markdown"
    ...
    private let logger = Logger(subsystem: "com.xielintao.annotamd", category: "UpdateService")
    ...
    func checkForUpdates() async throws -> GitHubRelease? {
        ...
        request.setValue("AnnotaMD/\(Self.currentVersion)", forHTTPHeaderField: "User-Agent")
