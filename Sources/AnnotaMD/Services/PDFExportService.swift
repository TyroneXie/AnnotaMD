...
enum PDFExportService {
    ...
    private static let logger = Logger(subsystem: "com.xielintao.annotamd", category: "PDFExportService")
...
private final class MRURLSchemeHandler: NSObject, WKURLSchemeHandler {
    ...
    private func resolveResourceURL(path: String) -> URL? {
        ...
        if let customPaths = resourceSearchPaths {
            ...
            // 同 MarkdownURLSchemeHandler：SPM 资源 bundle 有扁平（单架构）与
            // Xcode 式（universal，Contents/Resources/Resources/）两种布局，都要搜。
