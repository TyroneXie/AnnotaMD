...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let logger = Logger(subsystem: "com.xielintao.annotamd", category: "AppDelegate")
    ...
    func applicationWillFinishLaunching(_ notification: Notification) {
        ...
        // 会因 bundle 路径变化而再起一个进程，导致两个 AnnotaMD 同时运行——两边的启动
    ...
    private func relinquishToExistingInstanceIfNeeded() -> Bool {
        ...
        logger.info("Another AnnotaMD instance is already running (pid \(existing.processIdentifier)); relinquishing.")
    ...
    /// 禁用 AppKit/SwiftUI 的系统窗口状态恢复。AnnotaMD 自己通过
    ...
    @objc(openInAnnotaMD:userData:error:)
    func openInAnnotaMD(
        ...
        guard !urls.isEmpty else {
            error.pointee = "No file or folder URL was provided to AnnotaMD."
...
final class FileDropOverlayView: NSView {
    ...
    private let logger = Logger(subsystem: "com.xielintao.annotamd", category: "FileDropOverlay")
