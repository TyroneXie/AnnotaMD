...
/// 主内容区当前已加载的文档类型。
///
/// Markdown 是 AnnotaMD 的主能力；非 Markdown 文本只作为只读 Raw 文本兜底查看。
...
final class DocumentViewModel {
    ...
    var content: String = "" {
        didSet {
            ...
            if isMarkdownDocument && !isLoading {
    ...
    static let untitledDirectory: URL = {
        let dir = FileManager.default.temporaryDirectory.appendingPathComponent("AnnotaMD")
