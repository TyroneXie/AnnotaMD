...
public enum PresetThemes {
    ...
    public static let darkThemes: [ThemeDefinition] = [
        ...
        ThemeDefinition(id: "typora-dark", name: "Typora Dark", type: .dark,
                        surface: "#363b40", ink: "#b8bfc6", accent: "#6dc1e7",
                        success: "#57ac57", danger: "#d95050", contrast: 35,
                        bodyFontFamily: "'Helvetica Neue',Helvetica,Arial,'Segoe UI Emoji','SF Pro',sans-serif",
                        headingFontFamily: "'Lucida Grande',Corbel,Georgia,serif",
                        codeFontFamily: "Monaco,Consolas,'Andale Mono','DejaVu Sans Mono',monospace",
                        bodyFontSize: "15px", lineHeight: "1.5", letterSpacing: "0"),
    ...
    public static let lightThemes: [ThemeDefinition] = [
        ...
        ThemeDefinition(id: "typora-light", name: "Typora", type: .light,
                        surface: "#ffffff", ink: "#333333", accent: "#4183c4",
                        success: "#1f883d", danger: "#cf222e", contrast: 18,
                        bodyFontFamily: "'Helvetica Neue',Helvetica,Arial,'Segoe UI Emoji','SF Pro',sans-serif",
                        codeFontFamily: "'Lucida Console',Consolas,Courier,monospace",
                        bodyFontSize: "15px", lineHeight: "1.5", letterSpacing: "0"),
