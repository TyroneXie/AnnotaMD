...
const OVERRIDES = {
  lucide: {
    html: 'code-xml', 'copy-markdown': 'file-code'
  },
  phosphor: {
    strong: 'text-b', strikethrough: 'text-strikethrough', italic: 'text-italic',
    underline: 'text-underline', paragraph: 'paragraph', more: 'dots-three',
    'insert-left': 'arrow-line-left', 'insert-right': 'arrow-line-right',
    'insert-above': 'arrow-line-up', 'insert-below': 'arrow-line-down',
    wrap: 'text-align-left', 'diagram-view': 'squares-four', fullscreen: 'arrows-out',
    'title-view': 'text-h', html: 'file-html', emoji: 'smiley',
    mermaid: 'flow-arrow', 'copy-markdown': 'markdown-logo'
  },
  remix: {
    strong: 'bold', strikethrough: 'strikethrough', italic: 'italic', underline: 'underline',
    more: 'more-2', paragraph: 'paragraph', 'horizontal-line': 'separator',
    unlink: 'link-unlink', delete: 'delete-bin-line',
    'insert-left': 'insert-column-left', 'insert-right': 'insert-column-right',
    'insert-above': 'insert-row-top', 'insert-below': 'insert-row-bottom',
    copy: 'file-copy-line', html: 'html5-line', quote: 'double-quotes-l',
    highlight: 'mark-pen-line', emoji: 'emotion-happy-line',
    'bullet-list': 'list-unordered', mermaid: 'flow-chart', duplicate: 'file-copy-line'
  },
  material: {
    strong: 'format-bold', strikethrough: 'format-strikethrough', italic: 'format-italic',
    underline: 'format-underlined', 'align-left': 'format-align-left',
    'align-center': 'format-align-center', 'align-right': 'format-align-right',
    paragraph: 'format-paragraph', 'horizontal-line': 'horizontal-rule',
    'move-up': 'arrow-upward', 'move-down': 'arrow-downward',
    'insert-left': 'arrow-left', 'insert-right': 'arrow-right',
    'insert-above': 'arrow-upward', 'insert-below': 'arrow-downward',
    more: 'more-horiz', 'diagram-view': 'dashboard', frontmatter: 'description',
    emoji: 'mood', 'copy-plain-text': 'text-fields', duplicate: 'content-copy',
    promote: 'arrow-upward', demote: 'arrow-downward'
  },
  hugeicons: {
    link: 'link-01', unlink: 'unlink-01', delete: 'delete-02',
    'move-up': 'arrow-up-01', 'move-down': 'arrow-down-01',
    'move-left': 'arrow-left-01', 'move-right': 'arrow-right-01',
    'insert-above': 'insert-row-up', 'insert-below': 'insert-row-down',
    'inline-image': 'image-01', 'heading-link': 'link-01', palette: 'paint-board',
    download: 'download-01', 'link-view': 'link-01', html: 'html-5',
    'ordered-list': 'left-to-right-list-number',
    'bullet-list': 'left-to-right-list-bullet', 'task-list': 'check-list',
    mermaid: 'flowchart-01', plantuml: 'hierarchy', 'copy-markdown': 'file-code',
    cut: 'scissor-01', promote: 'arrow-up-01', demote: 'arrow-down-01'
  },
  mdi: {
    strong: 'format-bold', strikethrough: 'format-strikethrough', italic: 'format-italic',
    underline: 'format-underline', paragraph: 'format-paragraph', more: 'dots-horizontal',
    'horizontal-line': 'minus',
    'insert-left': 'table-column-plus-before', 'insert-right': 'table-column-plus-after',
    'insert-above': 'table-row-plus-before', 'insert-below': 'table-row-plus-after',
    'title-view': 'format-title', quote: 'format-quote-open-outline',
    'task-list': 'format-list-checks', duplicate: 'content-duplicate'
  },
  bootstrap: {
    'text-style': 'type', strong: 'type-bold', strikethrough: 'type-strikethrough',
    italic: 'type-italic', underline: 'type-underline', paragraph: 'paragraph',
    'horizontal-line': 'hr', more: 'three-dots', 'copy-markdown': 'markdown',
    unlink: 'link-45deg', 'align-left': 'text-left', 'align-right': 'text-right',
    'title-view': 'type-h1', math: 'calculator', html: 'filetype-html',
    emoji: 'emoji-smile', 'ordered-list': 'list-ol', mermaid: 'diagram-3',
    flowchart: 'diagram-3', sequence: 'diagram-2'
  }
}
...
if (missing.length) {
  ...
  const output = `// Generated by scripts/generateOfficialIconThemes.mjs. Do not edit by hand.\n` +
