...
export const toolList: Record<'right' | 'bottom', MenuItem[]> = {
    right: [
        ...formatTools('row', 1),
        { label: 'Comment', action: 'comment', target: 'row', symbol: '', group: 2 },
        { label: 'Move Row Up', action: 'move', location: 'previous', target: 'row', symbol: '↑', group: 3 },
        { label: 'Move Row Down', action: 'move', location: 'next', target: 'row', symbol: '↓', group: 3 },
        { label: 'Remove Row', action: 'remove', target: 'row', symbol: '⌫', group: 4 },
    ],
    bottom: [
        ...
        { label: 'Comment', action: 'comment', target: 'column', symbol: '', group: 3 },
        { label: 'Move Column Left', action: 'move', location: 'left', target: 'column', symbol: '←', group: 4 },
        { label: 'Move Column Right', action: 'move', location: 'right', target: 'column', symbol: '→', group: 4 },
        { label: 'Reset Column Width', action: 'reset-width', target: 'column', symbol: '↔', group: 5 },
        { label: 'Remove Column', action: 'remove', target: 'column', symbol: '⌫', group: 6 },
    ],
};
