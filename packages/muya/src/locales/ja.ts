export const ja = {
    ...
    // tableTools
        ...
        'Heading 6': 'タイトル 6',
        'Set Number': '番号を設定',
        'Continue Heading Numbering': '見出し番号を続ける',
        'Restart Numbering': '番号を振り直す',
        'Set Number Value': '番号の値を設定',
        'Number Value': '番号の値',
        'Cancel': 'キャンセル',
        'Table Block': '表',
        'Display Math': '数式',
        ...
        'Text': 'テキスト',
        'Link Address': 'リンク',
        'Paste or enter link': 'リンクを貼り付けるか入力',
        'Confirm': '確認',
        'Remove Link': 'リンクを解除',
        'Link View': 'リンク表示',
        'Title View': 'タイトル表示',
        'Copy Link': 'リンクをコピー',
        'Copy Original Web Link': '元のWebページのリンクをコピー',
        'More': 'その他',
        'Image': '画像',
        'Eliminate': '書式をクリアする',
        // Code block
