...
describe('Native theme source', () => {
  ...
  it('uses dark native menus for dark AnnotaMD themes', () => {
  ...
  it('uses the shared AnnotaMD dark theme classification', () => {
  ...
  it('uses light native menus for light AnnotaMD themes', () => {
