    ...
    <div class="right-controls">
      <section class="search">
        ...
        <div class="button-group">
          <button
            class="button right"
            :data-tooltip="t('menu.edit.findPrevious')"
            :aria-label="t('menu.edit.findPrevious')"
            @click="find('prev')"
          >
            <el-icon :size="14">
              <ArrowUp />
          ...
          <button
            class="button"
            :data-tooltip="t('menu.edit.findNext')"
            :aria-label="t('menu.edit.findNext')"
            @click="find('next')"
          >
            <el-icon :size="14">
              <ArrowDown />
...
.search-bar [data-tooltip] {
  position: relative;
}

.search-bar [data-tooltip]::after {
  position: absolute;
  top: calc(100% + 6px);
  left: 50%;
  z-index: 20;
...
.search-bar [data-tooltip]:hover::after {
