...
!macro customInstall
  ...
  "Do you want to associate Markdown files (.md, .markdown, .mmd, .mdown, .mdtext, .mdx) with AnnotaMD?" /SD IDNO IDNO SkipAssoc

  ;— User clicked YES, perform the registry writes —
  WriteRegStr HKCU "Software\Classes\.md"       "" "AnnotaMD.Document"
  WriteRegStr HKCU "Software\Classes\.markdown" "" "AnnotaMD.Document"
  WriteRegStr HKCU "Software\Classes\.mmd"      "" "AnnotaMD.Document"
  WriteRegStr HKCU "Software\Classes\.mdown"    "" "AnnotaMD.Document"
  WriteRegStr HKCU "Software\Classes\.mdtxt"    "" "AnnotaMD.Document"
  WriteRegStr HKCU "Software\Classes\.mdtext"   "" "AnnotaMD.Document"
  WriteRegStr HKCU "Software\Classes\.mdx"      "" "AnnotaMD.Document"

  WriteRegStr HKCU "Software\Classes\AnnotaMD.Document" \
    "" "AnnotaMD Markdown Document"
...
!macro customUnInstall
  ...
  DeleteRegKey HKCU "Software\Classes\AnnotaMD.Document\shell\open\command"
  DeleteRegKey HKCU "Software\Classes\AnnotaMD.Document\shell\open"
  DeleteRegKey HKCU "Software\Classes\AnnotaMD.Document\shell"

  ; Delete the DefaultIcon and ProgID
  DeleteRegKey HKCU "Software\Classes\AnnotaMD.Document\DefaultIcon"
  DeleteRegKey HKCU "Software\Classes\AnnotaMD.Document"
